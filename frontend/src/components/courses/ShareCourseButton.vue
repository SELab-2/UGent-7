...
<template>
    <div v-tooltip.top="t('views.courses.share')">
        <Button
            ...
            <template #default>
                ...
                <div class="flex gap-2 justify-content-start">
                    <label for="linkDuration">{{ t('views.courses.linkDuration') }}</label>
                ...
                <div class="flex justify-content-end gap-2 mt-4">
                    ...
                    <Button @click="handleShare()" rounded>{{ t('views.courses.share') }}</Button>
                </div>
            </template>
            </Dialog>
    </div>
