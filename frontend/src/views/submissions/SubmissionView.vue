...
function submitFeedback(): void {
    if (editedFeedback.value === null) {
        createFeedback(feedbackTextValue.value,
        ...
        <div class="grid">
            ...
            <div class="col-8 md:col-7">
                ...
                <div class="feedback-section mb-3">
                    ...
                    <div v-if="feedbacks !== null  && feedbacks.length > 0" v-for="feedback in feedbacks" :key="feedback.id">
                        <div class="feedback-header-wrap">
                            <!-- Single feedback header -->
                            <p class="feedback-header mt-1"> {{ t('views.submissions.feedback.dateAndAuthor', [moment(feedback.creation_date).format('DD MMMM YYYY'), User.fromJSON(feedback.author).getFullName()]) }} </p>
