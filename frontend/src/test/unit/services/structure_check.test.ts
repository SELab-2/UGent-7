...
describe('structureCheck', (): void => {
    ...
    it('gets structureCheck data', async () => {
        ...
        expect(structureChecks.value?.[0]?.obligated_extensions).toStrictEqual([]);
        expect(structureChecks.value?.[0]?.blocked_extensions).toStrictEqual([]);
        ...
        expect(structureChecks.value?.[2]?.obligated_extensions).toStrictEqual([]);
        expect(structureChecks.value?.[2]?.blocked_extensions).toStrictEqual([]);
